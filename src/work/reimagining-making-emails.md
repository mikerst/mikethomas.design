...
These automations saved a lot of manual labour on a per email basis, however they also created additional complications of their own. We also felt as though we'd lost site of the 'real' HTML itself, as everything was being generated by a tool and therefore wasn't being written directly. Fixing errors became quite time consuming, and frustrating. This project provided a great opportunity to address these things.
